...
Theme files define colors for different UI elements. See [`assets/themes/high-contrast.json`](https://github.com/subsy/ralph-tui/blob/main/assets/themes/high-contrast.json) for a complete example.
